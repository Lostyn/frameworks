...
namespace fr.lostyneditor.inspector {
    ...
    public class ShowIfPropertyDrawCondition : PropertyDrawCondition {
        public override bool CanDrawProperty( SerializedProperty property ) {
            ...
            {
                string warnig = showIfAttribute.GetType().Name + " need a valid boolean condition field or method name to work";
                EditorDrawUtility.DrawHelpBox( warnig, MessageType.Warning, context: target );
